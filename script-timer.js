...
// NEW FUNCTION: Appends random AUFs to the start and end of a scramble
function applyRandomAUF(baseScramble) {
  ...
  // Cleans up any double spaces generated by empty strings
...
function setScramble() {
  ...
  if (filteredAlgs.length === 0) {
    ...
    // Pass the base scramble through our new randomizer before setting it
